        ...
        <section id="contact" className="py-20 container mx-auto px-6 text-center max-w-4xl relative">
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-navy/90 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="relative w-full max-w-md bg-navy-light border border-cyan-electric/30 rounded-xl shadow-2xl p-8 animate-in zoom-in duration-300">
                        {/* Close Button "X" */}
                        <button
                            onClick={() => setIsOpen(false)}
                            className="absolute -top-3 -right-3 w-8 h-8 bg-navy border border-cyan-electric/50 text-cyan-electric rounded-full flex items-center justify-center hover:bg-cyan-electric hover:text-navy transition-all z-[110] shadow-lg"
                            title="Close"
                        >
