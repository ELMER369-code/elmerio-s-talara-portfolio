    ...
    return (
        <section id="skills" className="py-20 container mx-auto px-6">
            <div className="flex items-center mb-12">
                <span className="font-mono text-cyan-electric text-xl mr-4">03.</span>
                ...
                <div className="w-full max-w-4xl bg-navy-deep border border-slate-700 rounded-lg shadow-2xl overflow-hidden font-mono text-sm">
                    ...
                    <div className="p-6 md:p-10 space-y-6">
                        <div className="text-silver">
                            <span className="text-green-400">➜</span> <span className="text-cyan-electric">~</span> cat skills.json
                        </div>
                        ...
                        {features.map((feature, index) => (
                            <div key={index} className="ml-4 md:ml-8">
                                <span className="text-cyan-electric">"{feature.category}"</span>: [
                        ...
                        <div className="text-silver animate-pulse">
                            <span className="text-green-400">➜</span> <span className="text-cyan-electric">~</span> <span className="inline-block w-2 h-4 bg-slate-400 align-middle ml-1"></span>
                        </div>
                    </div>
                </div>
            </div>
